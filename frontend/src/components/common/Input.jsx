...
const Input = ({label, value, onChange, type = "text", error, name, showPasswordToggle = false}) => {
    ...
    return (
        <div className = "relative">
            ...
            {type === "password" && showPasswordToggle && (
                <button type = "button" onClick = {() => setVisible(!visible)} className = "absolute right-4 top-1/2 translate-y-1 text-gray-500">{visible ? (
