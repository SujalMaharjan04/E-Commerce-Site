    ...
    return (
        <div>
            <form className = "text-[#090F13]" onSubmit={handleSubmit}>
                ...
                <div className = "flex flex-col">
                    <label>Price</label>
                    <input type = "number" name = "price" placeholder = "Enter Price Here" className = "border border-solid border-2 rounded-xl pl-2" value = {formData.price} onChange = {handleChange} />
                </div>
                <div className = "flex flex-col">
                    <label>Stock</label>
                    <input type = "number" name = "stock" placeholder = "Enter Stock Here" className = "border border-solid border-2 rounded-xl pl-2" value = {formData.stock} onChange = {handleChange} />
                </div>

                <div className = "flex flex-col">
                    <label>Brand</label>
                    <select name = "selectedBrand" value = {formData.selectedBrand} onChange = {handleSelectChange} className = "border border-solid border-2 rounded-xl pl-2">
                ...
                <div className = "flex flex-col">
                    ...
                    <select name = "selectedCategory" value = {formData.selectedCategory} onChange = {handleSelectChange} className = "border border-solid border-2 rounded-xl pl-2">
